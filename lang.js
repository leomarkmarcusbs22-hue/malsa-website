...
const T = {
  ...
  ops_ffb_sub:     { en: "Our mill receives FFB from four categories of suppliers, all with 100% traceability to plantation level.", bm: "Kilang kami menerima BTS daripada empat kategori pembekal, semuanya dengan 100% kebolehkesanan ke peringkat ladang." },
  ops_mile21_title: { en: "Mile 21 (Batu 21)", bm: "Batu 21 (Mile 21)" },
  ops_mile21_desc:  { en: "Our primary FFB collecting site, equipped with a full weighbridge, loading ramp, and gen set facilities. Mile 21 handles significant volumes of FFB from surrounding estates, dealers, and smallholders. The site features dedicated transport logistics to ensure timely delivery of FFB to Malsa POM for processing.", bm: "Pusat pengumpulan BTS utama kami, dilengkapi dengan kemudahan jambatan timbang, jeti pemuatan, dan set penjana. Batu 21 mengendalikan jumlah BTS yang besar daripada estet, peniaga, dan pekebun kecil di sekitar. Tapak ini mempunyai logistik pengangkutan khusus bagi memastikan penghantaran BTS tepat pada masanya ke Malsa POM untuk pemprosesan." },
  ops_mile12_title: { en: "Mile 12 (Batu 12)", bm: "Batu 12 (Mile 12)" },
  ops_mile12_desc:  { en: "Strategically positioned along Jalan Labuk, Mile 12 serves as an efficient midpoint collection hub. The site is equipped with modern weighing systems and streamlined loading infrastructure, enabling quick turnaround of incoming FFB from estates and smallholders across the surrounding area.", bm: "Terletak secara strategik di sepanjang Jalan Labuk, Batu 12 berfungsi sebagai hab pengumpulan titik tengah yang cekap. Tapak ini dilengkapi sistem penimbangan moden dan infrastruktur pemuatan yang kemas, membolehkan pemulihan pantas BTS masuk daripada estet dan pekebun kecil di kawasan sekitar." },
  ops_matanggar_title: { en: "Matanggar", bm: "Matanggar" },
  ops_matanggar_desc:  { en: "Our largest collecting operation by FFB volume. Matanggar handles comprehensive purchasing and transport services, supported by a full complement of office, quarters, and safety infrastructure. The site plays a critical role in ensuring continuous FFB supply flow to the mill throughout the harvest cycle.", bm: "Operasi pengumpulan terbesar kami mengikut jumlah BTS. Matanggar mengendalikan perkhidmatan pembelian dan pengangkutan yang menyeluruh, disokong oleh kemudahan pejabat, kuarters, dan infrastruktur keselamatan yang lengkap. Tapak ini memainkan peranan penting dalam memastikan aliran bekalan BTS yang berterusan ke kilang sepanjang kitaran penuaian." },
